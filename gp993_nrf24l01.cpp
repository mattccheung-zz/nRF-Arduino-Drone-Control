...
static const u8 freqs[][8] = {{ 0x07, 0x24, 0x3e, 0x2b, 0x47, 0x0e, 0x39, 0x1c},{0x0f, 0x2a, 0x4b, 0x21, 0x2d, 0x36, 0x11, 0x35}};
...
static void v202_init()
{
    ...
    u8 rx_tx_addr[] = {0x2B, 0xA5, 0x37, 0xC5, 0x4A}; // with original doesnt work
...
const void *GP993_Cmds(enum ProtoCmds cmd)
{
    switch(cmd) {
        case PROTOCMD_INIT:
